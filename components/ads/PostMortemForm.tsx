  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`/api/ads/${ad.id}`, {
        ...
        body: JSON.stringify({
          spend: formData.spend !== '' ? parseFloat(formData.spend) : null,
          impressions: formData.impressions !== '' ? parseInt(formData.impressions) : null,
          clicks: formData.clicks !== '' ? parseInt(formData.clicks) : null,
          purchases: formData.purchases !== '' ? parseInt(formData.purchases) : null,
          revenue: formData.revenue !== '' ? parseFloat(formData.revenue) : null,
          videoViewThreeSeconds: formData.videoViewThreeSeconds !== '' ? parseInt(formData.videoViewThreeSeconds) : null,
          videoViewThruplay: formData.videoViewThruplay !== '' ? parseInt(formData.videoViewThruplay) : null,
